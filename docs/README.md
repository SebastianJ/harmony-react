...
The documentation that follows is for `@harmony-react/core`, the package responsible for managing this context. To understand where the data itself comes from, head over to the [connectors/ folder](./connectors/).
...
#### Example
```javascript
import { Web3ReactProvider } from '@harmony-react/core'
...
#### Example
```javascript
import { Web3ReactProvider, createWeb3ReactRoot } from '@harmony-react/core'
// import your favorite web3 convenience library here
...
#### Example
```javascript
import { getWeb3ReactContext } from '@harmony-react/core'
...
#### Example
```javascript
import { UnsupportedChainIdError } from '@harmony-react/core'
// ...
